package com.herick.nearby.ui.component.button
...
import com.herick.nearby.R
import com.herick.nearby.ui.theme.GreenBase
import com.herick.nearby.ui.theme.Typography

@Composable // controla todos os elementos visuais e declarativas
fun NearByButton(
...
@Preview
@Composable
private fun NearByButtonNoIncoPreview() {
    NearByButton(
        modifier = Modifier.fillMaxWidth(),
        text = "Confirmar"
    ) { }
